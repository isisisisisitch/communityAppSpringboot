package ca.bytetube.communityApp.web.local;
...
public class LocalAuthController {
    ...
    private Map<String, Object> bindLocalAuth(HttpServletRequest request) {
        ...
        if (userName != null && password != null && user != null && user.getUserId() != null) {
            ...
            modelMap.put("success", false);
            modelMap.put("errMsg", "user name and password can't be empty");
        }
        return modelMap;
    }
        ...
        if (userName != null && password != null && newPassword != null && user != null && user.getUserId() != null
            ...
            try {
                ...
                if (localAuth == null || !localAuth.getUsername().equals(userName)) {
                    // 不一致则直接退出
                    modelMap.put("success", false);
                    modelMap.put("errMsg", "The entered account is not the current login account");
                    return modelMap;
                }
                // 修改平台帐号的用户密码
            ...
            modelMap.put("success", false);
            modelMap.put("errMsg", "plz enter password");
        }
        return modelMap;
    }
    ...
    private Map<String, Object> logincheck(HttpServletRequest request) {
        ...
        if (userName != null && password != null) {
            ...
            if (localAuth != null) {
                ...
                modelMap.put("success", false);
                modelMap.put("errMsg", "user name or password is wrong");
            }
        } else {
            modelMap.put("success", false);
            modelMap.put("errMsg", "user name or password can't be empty");
        }
        return modelMap;
    }
