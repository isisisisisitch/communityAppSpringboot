$(function () {
    // 获取该店铺下的奖品列表URL
    var listUrl = '/communityApp/shopadmin/listawardsbyshop?pageIndex=1&pageSize=9999';
    // 设置奖品的可见状态
    var changeUrl = '/communityApp/shopadmin/modifyaward';
    getList();
        ...
        .on(
            ...
            function (e) {
                ...
                if (target.hasClass('edit')) {
                    ...
                    window.location.href = '/communityApp/shopadmin/awardoperation?awardId='
                    ...
                    window.location.href = '/communityApp/frontend/awarddetail?awardId='
                        + e.currentTarget.dataset.id;
                }
            });
    ...
    // 给新增按钮绑定点击事件
    $('#new').click(function () {
        window.location.href = '/communityApp/shopadmin/awardoperation';
    });
