$(function() {
	...
	// 根据主键获取授权信息的URL
	var infoUrl = '/communityApp/shopadmin/getshopauthmapbyid?shopAuthId=' + shopAuthId;
	// 修改授权信息的URL
	var shopAuthPostUrl = '/communityApp/shopadmin/modifyshopauthmap';

	if (shopAuthId) {
		getInfo(shopAuthId);
	} else {
		$.toast('user does not exist！');
		window.location.href = '/communityApp/shopadmin/shopmanage';
	}
