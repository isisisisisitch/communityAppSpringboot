$(function () {
    // 列出该店铺下所有授权信息的URL
    var listUrl = '/communityApp/shopadmin/listshopauthmapsbyshop?pageIndex=1&pageSize=9999';
    // 修改授权信息的URL
    var modifyUrl = '/communityApp/shopadmin/modifyshopauthmap';
    getList();
        ...
        .on(
            ...
            function (e) {
                ...
                if (target.hasClass('edit')) {
                    window.location.href = '/communityApp/shopadmin/shopauthedit?shopAuthId='
