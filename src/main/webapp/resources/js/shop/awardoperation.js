$(function () {
    ...
    // 通过awardId获取奖品信息的URL
    var infoUrl = '/communityApp/shopadmin/getawardbyid?awardId=' + awardId;
    // 更新奖品信息的URL
    var awardPostUrl = '/communityApp/shopadmin/modifyaward';
    // 由于奖品添加和编辑使用的是同一个页面，
    // 该标识符用来标明本次是添加还是编辑操作
    var isEdit = false;
    if (awardId) {
        ...
        awardPostUrl = '/communityApp/shopadmin/addaward';
    }
