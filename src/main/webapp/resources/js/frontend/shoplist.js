$(function() {
	...
	var pageSize = 8;
	// 获取店铺列表的URL
	var listUrl = '/communityApp/frontend/listshops';
	// 获取店铺类别列表以及区域列表的URL
	var searchDivUrl = '/communityApp/frontend/listshopspageinfo';
	// 页码
	var pageNum = 1;
	...
	$('.shop-list').on('click', '.card', function(e) {
		...
		window.location.href = '/communityApp/frontend/shopdetail?shopId=' + shopId;
	});
